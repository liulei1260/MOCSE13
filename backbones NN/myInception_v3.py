...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=False, transform_input=False):
        ...
        self.lconv3 = nn.Conv2d(2048, 1, kernel_size = 1, stride=1, padding=0, bias=False)     ### sencond parameter is the channel number
    ...
    def forward(self, x):
        ...
        #feature_map3 = feature_map3*attention_map   ##wang zhushi 26/09/2021
        # 32x32x2048
        ...
        density_map3=torch.squeeze(density_map3)   #try 30/09/2021
        #density_map3 = density_map3.view(-1,density_map3.size(2),density_map3.size(3))   #try 30/09/2021
        # attention_map = attention_map.view(-1,attention_map.size(2),attention_map.size(3))  # no need
