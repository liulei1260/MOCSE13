...
scipy.io.savemat('./results_'+args.modelType+'_counting'+'.mat', mdict={'pred': pred, 'mse': mse, 'mae': mae,'mre': mre,'densityArray':densityArray})
torch.save(model.state_dict(), model_dir+'headCount_'+args.modelType+'_counting'+'.pt')
